$outputDir = "C:\Temp\BrightFlow"
$outputFile = "$outputDir\Chrome_History_PublicDataCheck.csv"
...
$historyPath = "$userProfile\AppData\Local\Google\Chrome\User Data\Default\History"
$tempHistory = "$env:TEMP\ChromeHistory_temp.db"
